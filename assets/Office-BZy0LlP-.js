import{d as s,t as a,r as c,j as e,M as h,b as G,T as p,B as u,a as H,c as Q,e as V,f as q,h as W,i as z,k as J,u as X,l as Y,m as _,n as j,I as ee,S as O,o as te,O as w,p as ae,s as ne,q as se,v as ie}from"./index-CbqwKm63.js";import{O as oe,P as re}from"./OfficeForm-kHHOWKkL.js";import{C as le,s as ce}from"./SpecnoLogo_Blue-CLQ5BLkJ.js";const de="data:image/svg+xml,%3csvg%20width='25'%20height='24'%20viewBox='0%200%2025%2024'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M12.5%207C13.6%207%2014.5%206.1%2014.5%205C14.5%203.9%2013.6%203%2012.5%203C11.4%203%2010.5%203.9%2010.5%205C10.5%206.1%2011.4%207%2012.5%207ZM12.5%2010C11.4%2010%2010.5%2010.9%2010.5%2012C10.5%2013.1%2011.4%2014%2012.5%2014C13.6%2014%2014.5%2013.1%2014.5%2012C14.5%2010.9%2013.6%2010%2012.5%2010ZM10.5%2019C10.5%2017.9%2011.4%2017%2012.5%2017C13.6%2017%2014.5%2017.9%2014.5%2019C14.5%2020.1%2013.6%2021%2012.5%2021C11.4%2021%2010.5%2020.1%2010.5%2019Z'%20fill='%2322282F'/%3e%3c/svg%3e",fe=({isOpen:i,onClose:d,member:r,onEdit:m,onDelete:t})=>{const[o,g]=c.useState(!1);return o?e.jsx(h,{isOpen:i,onClose:d,children:e.jsxs(E,{children:[e.jsxs(ue,{children:[e.jsx(pe,{onClick:()=>g(!1),children:e.jsx("img",{src:G,alt:"Go back",width:24,height:24})}),e.jsx(p,{variant:"h4",children:"Are you sure you want to delete staff member?"})]}),e.jsxs(me,{children:[e.jsx(u,{variant:"danger",onClick:()=>{t(r),d()},children:"Delete Member"}),e.jsx(u,{variant:"secondary",onClick:()=>{g(!1),d()},children:"Keep Member"})]})]})}):e.jsx(h,{isOpen:i,onClose:d,children:e.jsxs(E,{children:[e.jsx(u,{variant:"primary",onClick:()=>{m(r),d()},children:"Edit Staff Member"}),e.jsx(u,{variant:"warning",onClick:()=>g(!0),children:"Delete Staff Member"})]})})},E=s.div`
  display: flex;
...
`,A={avatar01:H,avatar02:Q,avatar03:V,avatar04:q,avatar05:W,avatar06:z,avatar07:J},ge=({members:i,onEditMember:d,onDeleteMember:r})=>{const[m,t]=c.useState(null);return e.jsxs(he,{children:[e.jsxs(xe,{children:[e.jsx(p,{variant:"h3-semibold",children:"Staff Members In Office"}),e.jsx(p,{variant:"body-m",children:i.length})]}),e.jsx(ve,{children:i.map(o=>e.jsxs(ye,{children:[e.jsxs(be,{children:[e.jsx(je,{src:o.avatar?A[o.avatar]:A.avatar01,alt:`${o.firstName} ${o.lastName}`}),e.jsx(Ce,{children:e.jsxs(p,{variant:"body-m",children:[o.firstName," ",o.lastName]})})]}),e.jsx(we,{onClick:()=>t(o),children:e.jsx("img",{src:de,alt:"More options",width:24,height:24})})]},o.id))}),m&&e.jsx(fe,{isOpen:!!m,onClose:()=>t(null),member:m,onEdit:d,onDelete:r})]})},he=s.div`
  display: flex;
  flex-direction: column;
  gap: ${a.layout.gap.md};
...
`,Ie=()=>{const{id:i}=X(),[d]=Y(),r=_(),m=d.get("mode")==="edit",[t,o]=c.useState(null),[g,f]=c.useState(null),[S,C]=c.useState(!1),[N,x]=c.useState(Date.now()),[$,v]=c.useState(!1),[M,y]=c.useState(null),[k,B]=c.useState(""),[D,b]=c.useState(!1);c.useEffect(()=>{if(i){const n=j(i);n?o(n):r("/")}},[i,r,N]),c.useEffect(()=>{const n=()=>{x(Date.now())};return window.addEventListener("officeUpdated",n),()=>{window.removeEventListener("officeUpdated",n)}},[]);const I=()=>{if(i)try{te(i),b(!1),r("/")}catch(n){n instanceof w?f(n.message):f("Failed to delete office")}},U=()=>{b(!0)},F=n=>{f(null);try{if(!t)return;ae({...n,id:t.id,createdAt:t.createdAt,updatedAt:new Date().toISOString(),members:t.members||[]}),x(Date.now()),r(`/office/${i}`)}catch(l){l instanceof w?f(l.message):f("Failed to update office")}},P=n=>{f(null);try{if(!t)return;ne({...n,id:t.id,createdAt:t.createdAt,updatedAt:new Date().toISOString(),members:t.members||[]}),x(Date.now()),r(`/office/${i}`)}catch(l){l instanceof w?f(l.message):f("Failed to save office")}},R=()=>{if(t){const n=j(t.id);n&&(o({...n,members:n.members||[]}),x(Date.now()))}C(!1)},Z=n=>{y(n),v(!0)},T=n=>{if(t&&M){se(t.id,n);const l=j(t.id);o(l||null),v(!1),y(null)}},K=n=>{if(t){ie(t.id,n.id);const l=j(t.id);o(l||null),window.dispatchEvent(new Event("officeUpdated"))}};return t?m?e.jsxs(L,{children:[e.jsx(oe,{initialValues:{officeName:t.officeName,address:t.address,email:t.email,phone:t.phone,capacity:t.capacity,accent:t.accent},onUpdate:F,onSave:P,onDelete:U,error:g}),D&&t&&e.jsx(h,{isOpen:D,onClose:()=>b(!1),children:e.jsx($e,{officeName:t.officeName,onDelete:I,onKeep:()=>b(!1)})})]}):e.jsxs(L,{children:[e.jsx(re,{title:"Office",onBack:()=>r("/")}),e.jsx(le,{id:t.id,companyName:t.officeName,totalStaff:t.members.length,officeCapacity:parseInt(t.capacity),phoneNumber:t.phone,emailAddress:t.email,companyAddress:t.address,accent:t.accent}),t.members.length>0&&e.jsx(De,{children:e.jsx(ee,{name:"search",type:"text",placeholder:"Search",value:k,onChange:n=>B(n.target.value),icon:e.jsx("img",{src:Se,alt:"Search"}),iconPosition:"right"})}),t.members.length===0?e.jsx(Oe,{children:e.jsxs(Ee,{children:[e.jsx(Ae,{children:e.jsx("img",{src:ce,alt:"Specno Logo"})}),e.jsx(p,{children:"Add staff members to this office using the + button"})]})}):e.jsx(ge,{members:t.members.filter(n=>{const l=k.toLowerCase();return(n.firstName||"").toLowerCase().includes(l)||(n.lastName||"").toLowerCase().includes(l)}),onEditMember:Z,onDeleteMember:K}),S&&e.jsx(h,{isOpen:S,onClose:()=>C(!1),children:e.jsx(O,{office:t,onClose:()=>C(!1),onSubmit:R})}),$&&e.jsx(h,{isOpen:$,onClose:()=>{v(!1),y(null)},children:e.jsx(O,{office:t,onClose:()=>{v(!1),y(null)},onSubmit:T,initialValues:M||void 0})})]}):null},L=s.div`
  display: flex;
  flex-direction: column;
  gap: ${a.layout.gap.md};
`,De=s.div`
